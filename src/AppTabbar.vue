...
export default {
  data () {
    return {
      ...
      tabs: [
        {
          label: 'Albums',
          icon: this.md ? null : 'ion-ios-albums',
          page: Albums,
          theme: blue
        },
        {
          label: 'Artistes',
          icon: this.md ? null : 'ion-ios-musical-notes',
          page: Artists,
          theme: red
        },
        {
          label: 'Chansons',
          icon: this.md ? null : 'ion-ios-play',
          page: Tracks,
          theme: purple
        }
      ]
  ...
  computed: {
    ...
    title() {
      return this.md ? 'Music Finder' : this.tabs[this.index].title || this.tabs[this.index].label;
    },
    swipeTheme() {
      return this.md && {
